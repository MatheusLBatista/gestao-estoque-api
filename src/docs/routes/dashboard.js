...
const dashboardRoutes = {
                      ...
                      categoria_A: {
                        ...
                        properties: {
                          count: {
                            ...
                            example: 15,
                            description:
                              "Quantidade de produtos na categoria A",
                          },
                          descricao: {
                            type: "string",
                      ...
                      categoria_B: {
                        ...
                        properties: {
                          count: {
                            ...
                            example: 23,
                            description:
                              "Quantidade de produtos na categoria B",
                          },
                          descricao: {
                            type: "string",
                      ...
                      categoria_C: {
                        ...
                        properties: {
                          count: {
                            ...
                            example: 42,
                            description:
                              "Quantidade de produtos na categoria C",
                          },
                          descricao: {
                            type: "string",
  ...
  "/dashboard/categorias/categoria-a": {
    get: {
      tags: ["Dashboard"],
  ...
  "/dashboard/categorias/categoria-b": {
    get: {
      tags: ["Dashboard"],
  ...
  "/dashboard/categorias/categoria-c": {
    get: {
      tags: ["Dashboard"],
